    ...
    @section('content')
        ...
        <section class="bg-gray-100">
            ...
            <div id="default-carousel" class="mt-10 relative w-full overflow-hidden rounded-md shadow-lg shadow-black" data-carousel="slide">
                <!-- Carousel wrapper -->
                <div class="relative overflow-hidden" style="height: 50vh">
                    ...
                    <div class="flex flex-col sm:flex-row w-full h-full transition-opacity duration-1000 ease-in-out"
                        data-carousel-item>
                        <!-- Image -->
                        <div class="relative w-full sm:w-5/8 h-52 sm:h-full">
                            <img src="{{ asset('storage/' . $n->gambar_news) }}"
                                class="block w-full h-full object-cover" alt="...">
                            <div class="absolute inset-0 md:bg-gradient-to-l from-white from-10% to-transparent to-20%">
                            </div>
                        </div>
                        <!-- Caption and description box -->
                        <div class="w-full sm:w-3/8 bg-white p-6 md:p-10 flex items-center justify-center h-full">
                            <div>
                                <h2 class="text-black text-2xl md:text-4xl font-bold mb-2 md:mb-4">{{$n->name_news}}</h2>
                                <p class="text-black text-sm md:text-lg mb-4">{{$n->deskripsi_news}}</p>
                                <a href="{{$n->link_news}}">
                                    <button
                            ...
                            <div class="flex place-content-center">
                                <a href="{{ route('event.show', $event->id_event) }}">
                                    <div class="p-4 flex-shrink border rounded transition transform hover:scale-105 hover:bg-gray-100"
                                        style="max-width: 500px; height: 700px;">
                                        <img src="{{ asset('storage/' . $event->gambar_event) }}"
                                            alt="{{ $event->nama_event }}" class="w-700 h-700">
                                        <h3 class="text-2xl mt-5 leading-8 font-medium text-gray-900">
                                            {{ $event->nama_event }}</h3>
            ...
            <section class="w-full relative">
                <div class="flex flex-col md:flex-row bg-black bg-opacity-50 items-center w-full">
                    <img src="../public/content/foto_divisi/PUBGM.jpg" alt="PUBG Mobile"
                        class="w-full h-80 sm:h-96 object-cover">
                    <div
                        class="absolute top-0 left-0 right-0 bottom-0 z-30 flex flex-col items-center justify-center p-6 text-center bg-black bg-opacity-50 backdrop-blur-lg">
                        <img src="../public/content/foto_divisi/PUBGMLogo.png" alt="PUBG Mobile Logo"
                            class="w-40 sm:w-60 h-auto">
                    </div>
                </div>
            </section>
            ...
            <div id="default-carousel" class="mb-20 relative w-full" data-carousel="slide">
                ...
                <div
                    class="absolute top-0 left-0 right-0 bottom-0 z-30 flex flex-col items-center justify-center p-6 text-center bg-black bg-opacity-50 backdrop-blur-lg">
                    <h2 class="text-white text-3xl font-bold mb-4">Join our community</h2>
