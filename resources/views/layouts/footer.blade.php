    ...
    <footer class="bg-gray-800 w-full mt-auto">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between">
                <p class="mt-5 text-left text-xs sm:text-base text-gray-400">
                ...
                <div class="flex justify-end space-x-2 sm:space-x-5">
                    <a href="https://www.instagram.com/polinemaesports/" target="_blank">
                        <svg class="mt-5 h-6 sm:h-8 w-6 sm:w-8 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 448 512">
                            <path
                    ...
                    <a href="https://www.youtube.com/@polinemaesport">
                        <svg class="mt-5 h-6 sm:h-8 w-6 sm:w-8 text-gray-400" cxmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 576 512">
                    ...
                    <a href="https://www.tiktok.com/@polinemaesports">
                        <svg class="mt-5 h-5 sm:h-7 w-5 sm:w-7 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 448 512">
                            <path
