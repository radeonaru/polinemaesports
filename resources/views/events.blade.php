            ...
            <div class="mt-10">
                <div class="flex">
                    <div class="p-4 flex-shrink-0 border rounded">
                        <img src="{{asset('../public/' . $event->gambar_event)}}" alt="Event 1" height="300" width="300">
                    </div>
                    <div>
                        <h3 class="m-5 text-3xl text-gray-900 font-semibold">{{$event->nama_event}} </h3>
                        <div class="box-content h-48">
                            <p class="m-5 text-lg text-gray-500">{{$event->deskripsi_singkat}} </div>
                        ...
                        <div class="flex justify-between">
                            <a href="{{ route('event.show', $event->id_event) }}" class="flex hover:text-yellow-500">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6 ml-1 mt-0.5 text-black-500" width="30" height="30">>
